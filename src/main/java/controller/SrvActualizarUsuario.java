...
public class SrvActualizarUsuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        idUsuario = Integer.parseInt(request.getParameter("txtidusuario").toString());
        ...
        respuesta = webServiceSvc.getWebServiceSvcPort().actualizarUsuario(nombre, apellido, email, password, idUsuario);
