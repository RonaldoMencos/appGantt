...
public class SrvMantenimientoEmpresa extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("eliminar") != null) {
            ...
            respuesta = service.getWebServiceSvcPort().eliminarEmpresa(idEliminar);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("txtBuscar") != null && !request.getParameter("txtBuscar").toString().isEmpty()) {
            ...
            idEmpresa = Integer.parseInt(request.getParameter("txtBuscar").toString());
