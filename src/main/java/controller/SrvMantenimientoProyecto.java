 ...
 * @author oscar
 */
public class SrvMantenimientoProyecto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
           ...
           if (request.getParameter("eliminar") != null) {
               ...
               respuesta =service.getWebServiceSvcPort().eliminarProyecto(idEliminar);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("txtBuscar")!=null && !request.getParameter("txtBuscar").toString().isEmpty()) {
            ...
            idProyecto = Integer.parseInt(request.getParameter("txtBuscar").toString());
