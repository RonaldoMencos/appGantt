...
public class SrvActualizarProyecto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SrvActualizarProyecto.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int respuesta, empresa,idProyecto;
        idProyecto = Integer.parseInt(request.getParameter("txtidproyecto").toString());
        ...
        try {
            respuesta = webServiceSvc.getWebServiceSvcPort().actualizarProyecto(titulo, descripcion, fechaInicio, fechaFin, empresa,idProyecto);
