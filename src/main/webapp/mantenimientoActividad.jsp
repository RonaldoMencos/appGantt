                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%=f.format(ac.getFechaInicio().toGregorianCalendar().getTime())%></td>
                                <td><%=f.format(ac.getFechaFin().toGregorianCalendar().getTime())%></td>
                                <td><%=t.getTitulo()%></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><%=f.format(a.getFechaInicio().toGregorianCalendar().getTime())%></td>
                                <td><%=f.format(a.getFechaFin().toGregorianCalendar().getTime())%></td>
                                <td><%=t.getTitulo()%></td>
                                <td>
